 ...
 */
add_filter( 'template_include', array( 'Fairy_Style_Wrapping', 'wrap' ), 99 );
add_filter( 'fairy_style_wrap_base', 'fairy_style_wrap_base_cpts' );
 ...
 */
function fairy_style_template_path() {
	return Fairy_Style_Wrapping::$main_template;
}
 ...
 */
function fairy_style_template_base() {
	return Fairy_Style_Wrapping::$base;
}

if ( ! class_exists( 'Fairy_Style_Wrapping' ) ) {
	...
	class Fairy_Style_Wrapping {
		...
		/**
		 * Initialize new instance of Fairy_Style_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'fairy_style_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Fairy_Style_Wrapping class.
		 *
		 * @since 1.0.0
		...
		public static function wrap( $main ) {
			...
			return new Fairy_Style_Wrapping();
		}
	}
}
 ...
 */
function fairy_style_wrap_base_cpts( $templates ) {
