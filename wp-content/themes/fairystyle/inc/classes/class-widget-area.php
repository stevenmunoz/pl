...
if ( ! class_exists( 'Fairy_Style_Widget_Area' ) ) {

	class Fairy_Style_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'fairy_style_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'fairy_style_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'fairy_style_widget_area_classes', $classes, $area_id );
	...
	function fairy_style_widget_area() {
		return Fairy_Style_Widget_Area::get_instance();
	}

	fairy_style_widget_area();
}
