 ...
 * @return void
 */
function fairy_style_meta_author( $context = 'loop', $args = array() ) {
	...
	if ( ! fairy_style_is_meta_visible( $meta, $context ) ) {
		return;
	}
	...
	$author_format = apply_filters(
		'fairy_style_meta_author_format',
 ...
 * @return void
 */
function fairy_style_meta_date( $context = 'loop', $args = array() ) {
 ...
 * @return void
 */
function fairy_style_meta_comments( $context = 'loop', $args = array() ) {
	...
	$comments_format = apply_filters(
		'fairy_style_meta_comments_format',
 ...
 * @return void
 */
function fairy_style_meta_categories( $context = 'loop', $args = array(), $echo = true ) {
	...
	$categories_format = apply_filters(
		'fairy_style_meta_categories_format',
 ...
 * @return void
 */
function fairy_style_meta_tags( $context = 'loop', $args = array() ) {
 ...
 * @return array
 */
function fairy_style_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	$default_config = apply_filters( 'fairy_style_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'fairy_style_share_button_html',
	...
	foreach ( (array) $networks as $id => $network ) :
		...
		$share_buttons .= sprintf(
			...
			esc_html__( 'Share on ', 'fairy_style' ) . $network['name'],
 ...
 * @return bool
 */
function fairy_style_is_meta_visible( $meta, $context = 'loop' ) {

	if ( ! $meta ) {
		return false;
	}

	$meta_enabled = get_theme_mod( $meta, fairy_style_theme()->customizer->get_default( $meta ) );
