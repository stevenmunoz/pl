...
add_action( 'woocommerce_before_single_product', 'fairy_style_enqueue_single_product_scripts' );
...
add_filter( 'yith_wcwl_wishlist_title', 'fairy_style_yith_wcwl_wishlist_title' );
...
function fairy_style_yith_wcwl_wishlist_title() {
	return '';
}